...
(custom-set-variables
 ...
 '(package-selected-packages
   '(php-mode ido-vertical-mode vertico yasnippet-snippets yasnippet markdown-mode auto-complete ef-themes magit cyberpunk-theme pdf-tools org-bullets gruber-darker-theme auctex)))
(custom-set-faces
